...
class AlunoView extends TPage{
    ...
    */
    ...
    private static function renderDadosAluno( $dadosAluno ){        
        $html = new HtmlRendererConstructor( 'app/resources/identificador-aluno/dados-aluno.html' );
        $html->enableSection( 'main', $dadosAluno );
